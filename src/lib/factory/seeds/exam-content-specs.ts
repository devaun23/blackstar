...
export const MEDICINE_NODES: MedicineNodeSpec[] = [
  ...
  // =========================================================================
  // ADDITIONAL HIGH-YIELD NODES (15 nodes to reach 135 total)
  // =========================================================================
  ...
  // CARD +2
  {
    ...
    task_type: 'diagnosis', clinical_setting: 'ed', age_group: 'middle_aged',
    time_horizon: 'immediate', yield_tier: 'tier_1',
    exam_frequency: 75, clinical_frequency: 15,
    frequency_score: computeFrequencyScore({ exam_frequency: 75, clinical_frequency: 15 }),
    disease_family: 'aortic_disease',
    presentation_patterns: ['chest_pain'],
    acuity_band: 'emergent', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Diagnose aortic dissection: tearing chest pain with BP differential, widened mediastinum; classify Stanford A vs B to determine surgical vs medical management',
    competing_diagnoses: ['Type A aortic dissection', 'Type B aortic dissection', 'STEMI', 'PE', 'Esophageal rupture'],
    key_distinguishing_features: ['Tearing/ripping quality radiating to back', 'Blood pressure differential between arms', 'Widened mediastinum on CXR', 'Aortic regurgitation murmur'],
    suppression_style: 'competing_pattern', noise_budget: 'medium', confirmatory_delay: 'mid',
    hinge_sentence_type: 'imaging_finding',
    misdirection_vectors: ['symptom_overlap', 'vital_sign_mismatch'],
    plausible_distractor_families: ['coronary_artery_disease', 'venous_thromboembolism'],
  ...
  {
    node_id: 'N_CARD013',
    canonical_id: 'MED.CARD.AORTSTN.DX.OUT.ELD',
    shelf: 'medicine', system: 'Cardiology', topic: 'Aortic Stenosis', subtopic: null,
    task_type: 'diagnosis', clinical_setting: 'outpatient', age_group: 'elderly',
    time_horizon: 'weeks', yield_tier: 'tier_1',
    exam_frequency: 70, clinical_frequency: 50,
    ...
    presentation_patterns: ['syncope', 'dyspnea'],
    acuity_band: 'subacute', difficulty_tier: 'straightforward',
    algorithm_concept: 'Diagnose severe aortic stenosis by murmur characteristics and echo; recognize classic triad (syncope, angina, HF) and timing of valve replacement',
    competing_diagnoses: ['Aortic stenosis', 'HOCM', 'Aortic sclerosis', 'Subaortic membrane'],
    key_distinguishing_features: ['Crescendo-decrescendo systolic murmur at RUSB', 'Parvus et tardus pulse', 'Late-peaking murmur', 'Reduced aortic valve area'],
    suppression_style: 'classic', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'physical_exam_finding',
    misdirection_vectors: ['demographic_mismatch', 'symptom_overlap'],
    plausible_distractor_families: ['arrhythmia', 'coronary_artery_disease'],
    required_reconciliation_steps: 2,
    nbme_sample_item_ids: [],
  },
  ...
  {
    node_id: 'N_PULM012',
    canonical_id: 'MED.PULM.SARC.DXT.OUT.YA',
    shelf: 'medicine', system: 'Pulmonary', topic: 'Sarcoidosis', subtopic: null,
    task_type: 'diagnostic_test', clinical_setting: 'outpatient', age_group: 'young_adult',
    time_horizon: 'weeks', yield_tier: 'tier_1',
    exam_frequency: 65, clinical_frequency: 20,
    frequency_score: computeFrequencyScore({ exam_frequency: 65, clinical_frequency: 20 }),
    disease_family: 'interstitial_lung_disease',
    presentation_patterns: ['cough_fever', 'rash_systemic'],
    acuity_band: 'subacute', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Diagnose sarcoidosis with bilateral hilar lymphadenopathy, non-caseating granulomas on biopsy; assess for multisystem involvement (skin, eyes, calcium)',
    competing_diagnoses: ['Sarcoidosis', 'Lymphoma', 'Tuberculosis', 'Berylliosis', 'Hypersensitivity pneumonitis'],
    key_distinguishing_features: ['Bilateral hilar lymphadenopathy on CXR', 'Non-caseating granulomas', 'Elevated ACE level', 'Hypercalcemia', 'Erythema nodosum'],
    suppression_style: 'competing_pattern', noise_budget: 'medium', confirmatory_delay: 'mid',
    hinge_sentence_type: 'imaging_finding',
    misdirection_vectors: ['imaging_red_herring', 'demographic_mismatch'],
    plausible_distractor_families: ['leukemia_lymphoma', 'respiratory_infection'],
    required_reconciliation_steps: 3,
    nbme_sample_item_ids: [],
  },
  {
    node_id: 'N_PULM013',
    canonical_id: 'MED.PULM.PULMHTN.DXT.OUT.MID',
    shelf: 'medicine', system: 'Pulmonary', topic: 'Pulmonary Hypertension', subtopic: null,
    task_type: 'diagnostic_test', clinical_setting: 'outpatient', age_group: 'middle_aged',
    time_horizon: 'weeks', yield_tier: 'tier_2',
    exam_frequency: 50, clinical_frequency: 20,
    frequency_score: computeFrequencyScore({ exam_frequency: 50, clinical_frequency: 20 }),
    ...
    presentation_patterns: ['dyspnea'],
    acuity_band: 'subacute', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Work up unexplained dyspnea with elevated RVSP on echo; classify WHO group (1-5) to guide therapy; right heart catheterization confirms diagnosis',
    competing_diagnoses: ['Group 1 PAH', 'Group 2 (left heart)', 'Group 3 (lung disease)', 'Group 4 (CTEPH)', 'Deconditioning'],
    key_distinguishing_features: ['Elevated RVSP on echo', 'RV enlargement', 'Loud P2', 'WHO functional class', 'Right heart cath mPAP >20'],
    suppression_style: 'delayed_reveal', noise_budget: 'high', confirmatory_delay: 'late',
    hinge_sentence_type: 'imaging_finding',
    misdirection_vectors: ['symptom_overlap', 'lab_ambiguity'],
    plausible_distractor_families: ['heart_failure', 'obstructive_airway_disease'],
    required_reconciliation_steps: 3,
    nbme_sample_item_ids: [],
  },
  ...
  {
    node_id: 'N_HEME010',
    canonical_id: 'MED.HEME.PANCYTO.DXT.INP.MID',
    shelf: 'medicine', system: 'Hematology/Oncology', topic: 'Pancytopenia', subtopic: null,
    task_type: 'diagnostic_test', clinical_setting: 'inpatient', age_group: 'middle_aged',
    time_horizon: 'days', yield_tier: 'tier_1',
    exam_frequency: 55, clinical_frequency: 25,
    frequency_score: computeFrequencyScore({ exam_frequency: 55, clinical_frequency: 25 }),
    disease_family: 'leukemia_lymphoma',
    presentation_patterns: ['anemia', 'fever_unknown_source'],
    acuity_band: 'urgent', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Evaluate pancytopenia: peripheral smear → bone marrow biopsy; distinguish aplastic anemia, MDS, leukemia, megaloblastic, hypersplenism',
    competing_diagnoses: ['Aplastic anemia', 'MDS', 'Acute leukemia', 'Megaloblastic anemia', 'Hypersplenism'],
    key_distinguishing_features: ['Peripheral smear morphology', 'Reticulocyte count', 'Bone marrow cellularity', 'Blast percentage', 'B12/folate levels'],
    suppression_style: 'delayed_reveal', noise_budget: 'high', confirmatory_delay: 'late',
    hinge_sentence_type: 'lab_result',
    misdirection_vectors: ['lab_ambiguity', 'medication_confounder'],
    plausible_distractor_families: ['anemia_family'],
    required_reconciliation_steps: 3,
    nbme_sample_item_ids: [],
  },
  {
    node_id: 'N_HEME011',
    canonical_id: 'MED.HEME.LYMPH.DXT.OUT.MID',
    shelf: 'medicine', system: 'Hematology/Oncology', topic: 'Lymphoma', subtopic: 'Hodgkin vs Non-Hodgkin',
    task_type: 'diagnostic_test', clinical_setting: 'outpatient', age_group: 'middle_aged',
    time_horizon: 'weeks', yield_tier: 'tier_1',
    exam_frequency: 60, clinical_frequency: 20,
    frequency_score: computeFrequencyScore({ exam_frequency: 60, clinical_frequency: 20 }),
    disease_family: 'leukemia_lymphoma',
    presentation_patterns: ['weight_loss', 'fever_unknown_source'],
    acuity_band: 'subacute', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Evaluate lymphadenopathy with B symptoms: excisional biopsy to distinguish Hodgkin (Reed-Sternberg) from non-Hodgkin; staging with PET-CT',
    competing_diagnoses: ['Hodgkin lymphoma', 'Non-Hodgkin lymphoma', 'Reactive lymphadenopathy', 'Sarcoidosis', 'Metastatic cancer'],
    key_distinguishing_features: ['B symptoms (fever, night sweats, weight loss)', 'Reed-Sternberg cells', 'Contiguous vs non-contiguous spread', 'Age distribution'],
    suppression_style: 'delayed_reveal', noise_budget: 'high', confirmatory_delay: 'late',
    hinge_sentence_type: 'physical_exam_finding',
    misdirection_vectors: ['timeline_conflict', 'demographic_mismatch'],
    plausible_distractor_families: ['systemic_infection'],
    required_reconciliation_steps: 3,
    nbme_sample_item_ids: [],
  },
  ...
  // GI +2
  {
    node_id: 'N_GI009',
    canonical_id: 'MED.GI.GERD.NXT.OUT.MID',
    shelf: 'medicine', system: 'Gastroenterology', topic: 'GERD', subtopic: 'Management',
    task_type: 'next_step', clinical_setting: 'outpatient', age_group: 'middle_aged',
    time_horizon: 'chronic', yield_tier: 'tier_1',
    exam_frequency: 40, clinical_frequency: 90,
    frequency_score: computeFrequencyScore({ exam_frequency: 40, clinical_frequency: 90 }),
    disease_family: 'peptic_ulcer_disease',
    presentation_patterns: ['chest_pain', 'abdominal_pain'],
    acuity_band: 'chronic', difficulty_tier: 'straightforward',
    algorithm_concept: 'Manage GERD: lifestyle → PPI trial → alarm features trigger EGD; recognize Barrett esophagus screening indications',
    competing_diagnoses: ['GERD', 'Eosinophilic esophagitis', 'PUD', 'Functional dyspepsia', 'Achalasia'],
    key_distinguishing_features: ['Heartburn and regurgitation', 'Response to PPI', 'Alarm features (dysphagia, weight loss)', 'EGD findings'],
    suppression_style: 'management_hinge', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'response_to_treatment',
    misdirection_vectors: ['symptom_overlap'],
    plausible_distractor_families: ['coronary_artery_disease'],
  ...
  },
  {
    ...
    frequency_score: computeFrequencyScore({ exam_frequency: 55, clinical_frequency: 25 }),
    disease_family: 'malabsorption',
    presentation_patterns: ['diarrhea', 'weight_loss'],
    acuity_band: 'chronic', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Diagnose celiac disease: TTG-IgA serology while on gluten diet → duodenal biopsy for villous atrophy; screen in IDA, type 1 DM, dermatitis herpetiformis',
    competing_diagnoses: ['Celiac disease', 'IBS', 'Tropical sprue', 'Lactose intolerance', 'IBD', 'Small bowel bacterial overgrowth'],
    key_distinguishing_features: ['TTG-IgA positive', 'Villous atrophy on biopsy', 'Dermatitis herpetiformis', 'Iron deficiency anemia', 'Response to gluten-free diet'],
    suppression_style: 'delayed_reveal', noise_budget: 'medium', confirmatory_delay: 'mid',
    hinge_sentence_type: 'lab_result',
    misdirection_vectors: ['symptom_overlap', 'timeline_conflict'],
    plausible_distractor_families: ['inflammatory_bowel_disease'],
  ...
  {
    node_id: 'N_HEPA007',
    canonical_id: 'MED.HEPA.AIH.DX.OUT.YA',
    shelf: 'medicine', system: 'Hepatology', topic: 'Autoimmune Hepatitis', subtopic: null,
    task_type: 'diagnosis', clinical_setting: 'outpatient', age_group: 'young_adult',
    time_horizon: 'weeks', yield_tier: 'tier_1',
    exam_frequency: 55, clinical_frequency: 15,
    frequency_score: computeFrequencyScore({ exam_frequency: 55, clinical_frequency: 15 }),
    disease_family: 'chronic_liver_disease',
    presentation_patterns: ['jaundice', 'weakness_fatigue'],
    acuity_band: 'subacute', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Diagnose autoimmune hepatitis: ANA/SMA positive, elevated IgG, interface hepatitis on biopsy; distinguish from viral hepatitis, DILI, Wilson disease',
    competing_diagnoses: ['Autoimmune hepatitis', 'Viral hepatitis', 'DILI', 'Wilson disease', 'Primary biliary cholangitis'],
    key_distinguishing_features: ['ANA/anti-smooth muscle antibodies', 'Elevated IgG', 'Interface hepatitis on biopsy', 'Young female predominance', 'Response to steroids'],
    suppression_style: 'competing_pattern', noise_budget: 'medium', confirmatory_delay: 'mid',
    hinge_sentence_type: 'lab_result',
    misdirection_vectors: ['demographic_mismatch', 'lab_ambiguity'],
    plausible_distractor_families: ['viral_hepatitis'],
    required_reconciliation_steps: 3,
    nbme_sample_item_ids: [],
  },
  ...
  {
    node_id: 'N_ENDO011',
    canonical_id: 'MED.ENDO.OSTEO.RISK.OUT.ELD',
    shelf: 'medicine', system: 'Endocrinology', topic: 'Osteoporosis', subtopic: 'Screening and Treatment',
    task_type: 'risk_identification', clinical_setting: 'outpatient', age_group: 'elderly',
    time_horizon: 'chronic', yield_tier: 'tier_1',
    exam_frequency: 55, clinical_frequency: 70,
    frequency_score: computeFrequencyScore({ exam_frequency: 55, clinical_frequency: 70 }),
    disease_family: 'osteoporosis',
    presentation_patterns: ['weakness_fatigue'],
    acuity_band: 'chronic', difficulty_tier: 'straightforward',
    algorithm_concept: 'Screen with DEXA per USPSTF; T-score ≤−2.5 or FRAX threshold → bisphosphonate; manage contraindications and atypical femur fracture risk',
    competing_diagnoses: ['Primary osteoporosis', 'Secondary osteoporosis (steroid, hyperparathyroidism)', 'Osteomalacia', 'Multiple myeloma'],
    key_distinguishing_features: ['DEXA T-score', 'FRAX score', 'Fragility fracture history', 'Vitamin D level', 'Calcium/PTH'],
    suppression_style: 'management_hinge', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'lab_result',
    misdirection_vectors: ['medication_confounder', 'demographic_mismatch'],
    plausible_distractor_families: ['calcium_metabolism', 'paraneoplastic'],
    required_reconciliation_steps: 2,
    nbme_sample_item_ids: [],
  },
  ...
  {
    node_id: 'N_NEURO010',
    canonical_id: 'MED.NEURO.MIGRAINE.NXT.OUT.YA',
    shelf: 'medicine', system: 'Neurology-within-IM', topic: 'Migraine', subtopic: 'Prophylaxis',
    task_type: 'next_step', clinical_setting: 'outpatient', age_group: 'young_adult',
    time_horizon: 'chronic', yield_tier: 'tier_1',
    exam_frequency: 50, clinical_frequency: 80,
    frequency_score: computeFrequencyScore({ exam_frequency: 50, clinical_frequency: 80 }),
    ...
    presentation_patterns: ['headache_focal_deficit'],
    acuity_band: 'chronic', difficulty_tier: 'straightforward',
    algorithm_concept: 'Manage migraine: acute (triptans, NSAIDs) vs prophylaxis (topiramate, propranolol, amitriptyline, CGRP inhibitors) based on frequency and comorbidities',
    competing_diagnoses: ['Migraine with aura', 'Migraine without aura', 'Tension-type headache', 'Cluster headache', 'Medication overuse headache'],
    key_distinguishing_features: ['Unilateral pulsatile quality', 'Photophobia/phonophobia', 'Aura symptoms', 'Headache frequency diary', 'Medication overuse pattern'],
    suppression_style: 'management_hinge', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'medication_history',
    misdirection_vectors: ['medication_confounder', 'timeline_conflict'],
    plausible_distractor_families: ['cerebrovascular'],
  ...
  {
    node_id: 'N_NEURO011',
    canonical_id: 'MED.NEURO.STATEP.STAB.ED.MID',
    shelf: 'medicine', system: 'Neurology-within-IM', topic: 'Status Epilepticus', subtopic: null,
    task_type: 'stabilization', clinical_setting: 'ed', age_group: 'middle_aged',
    time_horizon: 'immediate', yield_tier: 'tier_1',
    exam_frequency: 65, clinical_frequency: 20,
    frequency_score: computeFrequencyScore({ exam_frequency: 65, clinical_frequency: 20 }),
    ...
    presentation_patterns: ['altered_mental_status'],
    acuity_band: 'emergent', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Manage status epilepticus: benzodiazepine → fosphenytoin/levetiracetam → intubation/continuous infusion; identify and treat precipitants',
    competing_diagnoses: ['Status epilepticus', 'Convulsive syncope', 'Psychogenic nonepileptic event', 'Eclampsia', 'Hypoglycemic seizure'],
    key_distinguishing_features: ['Seizure >5 min or recurrent without recovery', 'Post-ictal confusion', 'Tongue bite/incontinence', 'AED levels'],
    suppression_style: 'classic', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'temporal_pattern',
    misdirection_vectors: ['timeline_conflict', 'medication_confounder'],
    plausible_distractor_families: ['cerebrovascular', 'toxicology'],
    required_reconciliation_steps: 2,
    nbme_sample_item_ids: [],
  },
  ...
  {
    node_id: 'N_NEPH010',
    canonical_id: 'MED.NEPH.RTA.DX.OUT.MID',
    shelf: 'medicine', system: 'Nephrology', topic: 'Renal Tubular Acidosis', subtopic: null,
    task_type: 'diagnosis', clinical_setting: 'outpatient', age_group: 'middle_aged',
    time_horizon: 'weeks', yield_tier: 'tier_2',
    exam_frequency: 55, clinical_frequency: 15,
    frequency_score: computeFrequencyScore({ exam_frequency: 55, clinical_frequency: 15 }),
    disease_family: 'tubular_disease',
    presentation_patterns: ['acid_base_disorder', 'electrolyte_abnormality'],
    acuity_band: 'chronic', difficulty_tier: 'trap_heavy',
    algorithm_concept: 'Classify RTA by type: Type 1 (distal, urine pH >5.5, hypokalemia), Type 2 (proximal, bicarb wasting), Type 4 (hyperkalemic, low aldosterone); use urine anion gap',
    competing_diagnoses: ['Type 1 RTA (distal)', 'Type 2 RTA (proximal)', 'Type 4 RTA (hyperkalemic)', 'GI bicarbonate loss (diarrhea)', 'Normal AG acidosis from dilution'],
    key_distinguishing_features: ['Non-AG metabolic acidosis', 'Urine pH', 'Urine anion gap', 'Serum potassium level', 'Fractional excretion of bicarbonate'],
    suppression_style: 'competing_pattern', noise_budget: 'high', confirmatory_delay: 'mid',
    hinge_sentence_type: 'lab_result',
    misdirection_vectors: ['lab_ambiguity', 'medication_confounder'],
    plausible_distractor_families: ['acid_base_disorder_family'],
  ...
  // ID +2
  {
    node_id: 'N_ID011',
    canonical_id: 'MED.ID.CDIFF.NXT.INP.ELD',
    shelf: 'medicine', system: 'Infectious Disease', topic: 'Clostridioides difficile', subtopic: 'Recurrent',
    task_type: 'next_step', clinical_setting: 'inpatient', age_group: 'elderly',
    time_horizon: 'days', yield_tier: 'tier_1',
    exam_frequency: 60, clinical_frequency: 55,
    frequency_score: computeFrequencyScore({ exam_frequency: 60, clinical_frequency: 55 }),
    disease_family: 'systemic_infection',
    presentation_patterns: ['diarrhea', 'fever_unknown_source'],
    acuity_band: 'urgent', difficulty_tier: 'moderate_ambiguity',
    algorithm_concept: 'Manage C. diff: oral vancomycin (not metronidazole) for initial; fidaxomicin for recurrence; consider fecal microbiota transplant for ≥2 recurrences; stop inciting antibiotic',
    competing_diagnoses: ['C. difficile colitis', 'Viral gastroenteritis', 'Inflammatory colitis flare', 'Ischemic colitis', 'Medication-associated diarrhea'],
    key_distinguishing_features: ['Recent antibiotic exposure', 'PCR/toxin positive', 'Leukocytosis with bandemia', 'CT showing colonic wall thickening'],
    suppression_style: 'management_hinge', noise_budget: 'medium', confirmatory_delay: 'mid',
    hinge_sentence_type: 'medication_history',
    misdirection_vectors: ['medication_confounder', 'timeline_conflict'],
    plausible_distractor_families: ['inflammatory_bowel_disease'],
  ...
  {
    node_id: 'N_ID012',
    canonical_id: 'MED.ID.STI.DXT.OUT.YA',
    shelf: 'medicine', system: 'Infectious Disease', topic: 'Sexually Transmitted Infections', subtopic: 'Screening',
    task_type: 'diagnostic_test', clinical_setting: 'outpatient', age_group: 'young_adult',
    time_horizon: 'days', yield_tier: 'tier_1',
    exam_frequency: 50, clinical_frequency: 65,
    frequency_score: computeFrequencyScore({ exam_frequency: 50, clinical_frequency: 65 }),
    disease_family: 'sexually_transmitted_infection',
    presentation_patterns: ['rash_systemic'],
    acuity_band: 'subacute', difficulty_tier: 'straightforward',
    algorithm_concept: 'Screen and diagnose common STIs: chlamydia/gonorrhea NAAT, syphilis RPR/FTA-ABS algorithm, HSV PCR; appropriate treatment and partner notification',
    competing_diagnoses: ['Chlamydia', 'Gonorrhea', 'Primary syphilis', 'Secondary syphilis', 'Herpes simplex', 'Reactive arthritis'],
    key_distinguishing_features: ['NAAT results', 'RPR titer and FTA-ABS', 'Chancre vs condyloma lata', 'Urethral discharge character', 'Disseminated gonococcal features'],
    suppression_style: 'classic', noise_budget: 'low', confirmatory_delay: 'early',
    hinge_sentence_type: 'social_history',
    misdirection_vectors: ['social_history_bait', 'demographic_mismatch'],
    plausible_distractor_families: ['autoimmune_connective_tissue'],
    required_reconciliation_steps: 2,
    nbme_sample_item_ids: [],
  },
