...
export default function SectionCard({ label, children, variant = 'default', className }: SectionCardProps) {
  return (
    <div className={cn(
      'rounded-[var(--radius-card)] border p-[var(--space-card-padding)]',
      variantStyles[variant],
      className,
    )}>
      <h4 className={cn('text-xs font-semibold uppercase tracking-wider', labelColors[variant])}>
        {label}
      </h4>
